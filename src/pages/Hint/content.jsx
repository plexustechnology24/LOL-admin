...
const HintContent = () => {
    ...
    const handlePastedText = (text, html, editorState) => {
        ...
        const currentLength = [...currentText].length; // Use spread operator
        const availableChars = 60 - currentLength;
    ...
    const handleDeleteSelected = () => {
        ...
        const payload = {
            ids: selectedItems,
            TypeId: "5" // Use appropriate TypeId for hint content
        };
    ...
    const handleSubmit = async (e) => {
        ...
        // Check character limit using spread operator
        if ([...plainText].length > 60) {
            toast.error('Content must not exceed 60 characters');
            return;
        }
    ...
    const handleEdit = (content) => {
        const contentState = ContentState.createFromText(content.Content || '');
    ...
    return (
        <div>
            <PageBreadcrumb pageTitle="Hint Content" />
                            ...
                            <Table>
                                <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
                                    <TableRow>
                                        ...
                                        <TableCell isHeader className="py-7 font-medium text-gray-500 px-2 border-r border-gray-200 dark:border-gray-700">Hint Content</TableCell>
                    ...
                    <div className="relative bg-white rounded-lg w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto">
                        <div className="px-6 py-4 border-b">
                            <h3 className="text-xl font-semibold">
                                {id ? "Edit Hint Content" : "Add Hint Content"}
                            </h3>
                        </div>
                                ...
                                <div className="py-2">
                                    ...
                                    <div className="mb-4 relative">
                                        ...
                                        <div className="bg-gray-100 p-2 mb-2 rounded text-sm">
                                            <p>Type your message and use emoji picker for adding emojis. (Max 60 characters)</p>
                                        </div>
                                        ...
                                        >
                                            ...
                                            <div className="border-gray-300 p-2 flex justify-between items-center">
                                                <span className={`text-sm ${[...editorState.getCurrentContent().getPlainText()].length > 60 ? 'text-red-500' : 'text-gray-500'}`}>
                                                    {[...editorState.getCurrentContent().getPlainText()].length}/60
                                                </span>
                                                <button
                                                    type="button"
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[99999]">
                    <div className="bg-white rounded-lg p-6 w-full max-w-sm mx-4 shadow-lg">
                        <h2 className="text-xl font-semibold text-gray-800 mb-3">
                            {deleteModal.isBulk ? 'Delete Selected Items' : 'Delete Hint Content'}
                        </h2>

                        <p className="text-gray-700 mb-6">
                            {deleteModal.isBulk
                                ? `Are you sure you want to delete ${selectedItems.length} selected items?`
                                : 'Are you sure you want to delete this Hint Content?'
                            }
                        </p>
