...
const FriendContent = () => {
    ...
    const handleDeleteSelected = () => {
        ...
        const payload = {
            ids: selectedItems,
            TypeId: "17" // Use appropriate TypeId for friend content
        };
    ...
    const handleDelete = () => {
        axios
            .delete(`https://api.lolcards.link/api/content/delete/${deleteModal.id}`, { data: { question: "friend" } })
            .then((res) => {
    ...
    return (
        <div>
            <PageBreadcrumb pageTitle="Friend Content" />
                            ...
                            <Table>
                                <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
                                    <TableRow>
                                        ...
                                        <TableCell isHeader className="py-7 font-medium text-gray-500 px-2 border-r border-gray-200 dark:border-gray-700">Friend Content</TableCell>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[99999]">
                    <div className="bg-white rounded-lg p-6 w-full max-w-sm mx-4 shadow-lg">
                        <h2 className="text-xl font-semibold text-gray-800 mb-3">
                            {deleteModal.isBulk ? 'Delete Selected Items' : 'Delete Friend Content'}
                        </h2>

                        <p className="text-gray-700 mb-6">
                            {deleteModal.isBulk
                                ? `Are you sure you want to delete ${selectedItems.length} selected items?`
                                : 'Are you sure you want to delete this Friend Content?'
                            }
                        </p>
