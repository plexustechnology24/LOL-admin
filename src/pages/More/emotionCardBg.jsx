...
const EmotionCardBg = () => {
    ...
    const getData = useCallback((page = null) => {
        ...
        axios.post('https://api.lolcards.link/api/emotion/cardbg/read', payload)
            .then((res) => {
    ...
    const handleDelete = () => {
        axios
            .delete(`https://api.lolcards.link/api/emotion/cardbg/delete/${deleteModal.id}`)
            .then((res) => {
            ...
            if (id) {
                if (selectedFiles.length > 0) {
                    ...
                    const response = await axios.patch(
                        `https://api.lolcards.link/api/emotion/cardbg/update/${id}`,
                        formData
                    );
                ...
                for (const file of selectedFiles) {
                    ...
                    formData.append('Category', Category);
                    uploadPromises.push(
                        axios.post('https://api.lolcards.link/api/emotion/cardbg/create', formData)
                    );
                }
    ...
    return (
        <div>
            <PageBreadcrumb pageTitle="Emotion CardBg" />
                            ...
                            <Table>
                                <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
                                    <TableRow>
                                        ...
                                        <TableCell isHeader className="py-7 font-medium text-gray-500 px-2 border-r border-gray-200 dark:border-gray-700">Emotion CardBg</TableCell>
