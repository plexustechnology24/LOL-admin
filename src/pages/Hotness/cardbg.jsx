...
const HotnessCardBg = () => {
    ...
    const getData = useCallback((page = null) => {
        ...
        axios.post('https://api.lolcards.link/api/hotness/cardbg/read', payload)
            .then((res) => {
    ...
    const handleDelete = () => {
        axios
            .delete(`https://api.lolcards.link/api/hotness/cardbg/delete/${deleteModal.id}`)
            .then((res) => {
            ...
            if (id) {
                if (selectedFiles.length > 0) {
                    ...
                    const response = await axios.patch(
                        `https://api.lolcards.link/api/hotness/cardbg/update/${id}`,
                        formData
                    );
                ...
                for (const file of selectedFiles) {
                    ...
                    uploadPromises.push(
                        axios.post('https://api.lolcards.link/api/hotness/cardbg/create', formData)
                    );
                }
    ...
    return (
        <div>
            <PageBreadcrumb pageTitle="Hotness CardBg" />
                            ...
                            <Table>
                                <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
                                    <TableRow>
                                        ...
                                        <TableCell isHeader className="py-7 font-medium text-gray-500 px-2 border-r border-gray-200 dark:border-gray-700">Hotness CardBg</TableCell>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[99999]">
                    <div className="bg-white rounded-lg p-6 w-full max-w-sm mx-4 shadow-lg">
                        ...
                        <h2 className="text-xl font-semibold text-gray-800 mb-3">
                            {deleteModal.isBulk ? 'Delete Selected Items' : 'Delete Hotness CardBg'}
                        </h2>

                        <p className="text-gray-700 mb-6">
                            {deleteModal.isBulk
                                ? `Are you sure you want to delete ${selectedItems.length} selected items?`
                                : 'Are you sure you want to delete this Hotness CardBg?'
                            }
                        </p>
            ...
            <ImagePreviewModal
                ...
                images={currentItems.map(item => item.CardBg)}
