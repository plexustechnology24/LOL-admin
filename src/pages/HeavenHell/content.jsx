...
const HeavenHellContent2 = () => {
    ...
    const handleDeleteSelected = () => {
        ...
        const payload = {
            ids: selectedItems,
            TypeId: "20" // Use appropriate TypeId for hellheaven content
        };
    ...
    const handleDelete = () => {
        axios
            .delete(`https://api.lolcards.link/api/content/delete/${deleteModal.id}`, { data: { question: "hellheaven" } })
            .then((res) => {
    ...
    return (
        <div>
            <PageBreadcrumb pageTitle="Heaven Hell Content" />
                            ...
                            <Table>
                                <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
                                    <TableRow>
                                        ...
                                        <TableCell isHeader className="py-7 font-medium text-gray-500 px-2 border-r border-gray-200 dark:border-gray-700">Heaven Hell Content</TableCell>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[99999]">
                    <div className="bg-white rounded-lg p-6 w-full max-w-sm mx-4 shadow-lg">
                        <h2 className="text-xl font-semibold text-gray-800 mb-3">
                            {deleteModal.isBulk ? 'Delete Selected Items' : 'Delete Heaven Hell Content'}
                        </h2>

                        <p className="text-gray-700 mb-6">
                            {deleteModal.isBulk
                                ? `Are you sure you want to delete ${selectedItems.length} selected items?`
                                : 'Are you sure you want to delete this Heaven Hell Content?'
                            }
                        </p>
...
export default HeavenHellContent2;