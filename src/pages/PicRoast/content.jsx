...
const PicRoastContent = () => {
    ...
    const handlePastedText = (text, html, editorState) => {
        ...
        const currentLength = [...currentText].length; // Use spread operator
        const availableChars = 250 - currentLength;
    ...
    const handleDeleteSelected = () => {
        ...
        const payload = {
            ids: selectedItems,
            TypeId: "14" // Use appropriate TypeId for picroast content
        };
    ...
    const handleDelete = () => {
        axios
            .delete(`https://api.lolcards.link/api/content/delete/${deleteModal.id}`, { data: { question: "picroast" } })
            .then((res) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if ([...plainText].length > 250) {
            toast.error('Content must not exceed 250 characters');
            return;
        }
    ...
    return (
        <div>
            <PageBreadcrumb pageTitle="Pic Roast Content" />
                            ...
                            <Table>
                                <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
                                    <TableRow>
                                        ...
                                        <TableCell isHeader className="py-7 font-medium text-gray-500 px-2 border-r border-gray-200 dark:border-gray-700">Pic Roast Content</TableCell>
                                ...
                                <div className="py-2">
                                    ...
                                    <div className="mb-4 relative">
                                        ...
                                        <div className="bg-gray-100 p-2 mb-2 rounded text-sm">
                                            <p>Type your message and emoji picker for emojis. (Max 250 characters)</p>
                                        </div>
                                        ...
                                        >
                                            ...
                                            <div className="border-t border-gray-300 p-2 flex justify-between items-center">
                                                <span className={`text-sm ${[...editorState.getCurrentContent().getPlainText()].length > 250 ? 'text-red-500' : 'text-gray-500'}`}>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[99999]">
                    <div className="bg-white rounded-lg p-6 w-full max-w-sm mx-4 shadow-lg">
                        <h2 className="text-xl font-semibold text-gray-800 mb-3">
                            {deleteModal.isBulk ? 'Delete Selected Items' : 'Delete Pic Roast Content'}
                        </h2>

                        <p className="text-gray-700 mb-6">
                            {deleteModal.isBulk
                                ? `Are you sure you want to delete ${selectedItems.length} selected items?`
                                : 'Are you sure you want to delete this Pic Roast Content?'
                            }
                        </p>
...
export default PicRoastContent;